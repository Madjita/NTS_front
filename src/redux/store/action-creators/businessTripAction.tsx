...
import {
  IBusinessTrip,
  IReportCheck,
} from "../../../components/IDataInterface/IDataInterface";
...
export const fetchBusinessTrips_finish = (
  sessionToken: any,
  newBusinessTrip: IBusinessTrip
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      //dispatch({type: BusinessTripActionTypes.FETCH_BUSINESS_TRIP})
...
export const fetchBusinessTrips_add = (
  sessionToken: any,
  newBusinessTrip: IBusinessTrip
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
...
export const fetchBusinessTrips_edit = (
  sessionToken: any,
  edit_BusinessTrip: IBusinessTrip,
  old_BusinessTrip: IBusinessTrip
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      //dispatch({type: BusinessTripActionTypes.FETCH_BUSINESS_TRIP})
      const json = JSON.stringify({
        old: old_BusinessTrip,
        edit: edit_BusinessTrip,
      });
...
export const fetchBusinessTripsChecks_selected_all = (
  sessionToken: any,
  selectedBusinessTrip: IBusinessTrip
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      const json = JSON.stringify({
...
export const fetchBusinessTripsChecks_add = (
  sessionToken: any,
  newReportCheck: IReportCheck
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      let formData: FormData = new FormData();
      formData.append(
        "File_checkBankPhotoByte",
        newReportCheck.checkBankPhotoByte as File
      );
      formData.append(
        "File_ticketPhotoByte",
        newReportCheck.ticketPhotoByte as File
      );
      formData.append(
        "File_borderTicketPhotoByte",
        newReportCheck.borderTicketPhotoByte as File
      );
      formData.append(
        "File_billPhotoByte",
        newReportCheck.billPhotoByte as File
      );
      ...
      setTimeout(() => {
        dispatch({
          ...
          payload: newReportCheck,
          select: newReportCheck.businessTrip as IBusinessTrip,
        });
      }, sleepLoader);
    } catch (e) {
      dispatch({
...
export const fetchBusinessTripsChecks_edit = (
  sessionToken: any,
  editReportCheck: IReportCheck,
  oldReportCheck: IReportCheck
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      let formData: FormData = new FormData();
      formData.append(
        "File_checkBankPhotoByte",
        editReportCheck.checkBankPhotoByte as File
      );
      formData.append(
        "File_ticketPhotoByte",
        editReportCheck.ticketPhotoByte as File
      );
      formData.append(
        "File_borderTicketPhotoByte",
        editReportCheck.borderTicketPhotoByte as File
      );
      formData.append(
        "File_billPhotoByte",
        editReportCheck.billPhotoByte as File
      );
      formData.append(
        "jsonString",
        JSON.stringify({
          old: oldReportCheck,
          edit: editReportCheck,
        })
      );
      ...
      const response = await axios.put(
        ...
        formData,
        {
          headers: {
            Authorization: sessionToken,
            "Content-Type": "application/vnd.someprovider.invoice+json",
          },
        }
      );
      ...
      if (response.status === 200) {
        setTimeout(() => {
          dispatch({
            ...
            edit: editReportCheck,
            old:  oldReportCheck,
            select: editReportCheck.businessTrip as IBusinessTrip
          });
        }, sleepLoader);
      }
    } catch (e) {
      dispatch({
        type: BusinessTripActionTypes.FETCH_BUSINESS_TRIP_ERROR,
        payload: "Произошла ошибка при редактировании чека в командировке",
      });
    }
  };
};

export const fetchBusinessTrip_delete = (
  sessionToken: any,
  selectedBusinessTrip: IBusinessTrip
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      console.log(
        "businessTripHook.businessTrips[index] = ",
...
export const fetchBusinessTripCheck_delete = (
  sessionToken: any,
  selectedReportCheck: IReportCheck
) => {
  return async (dispatch: Dispatch<BusinessTripAction>) => {
    try {
      ...
      setTimeout(() => {
        dispatch({
          ...
          payload: selectedReportCheck,
          select: selectedReportCheck.businessTrip as IBusinessTrip,
        });
      }, sleepLoader);
    } catch (e) {
      dispatch({
